...
namespace Kukux\DigitalSignature\Filament\Resources\SignatureResource\Pages\V4;
...
class ViewSignature extends ViewRecord
{
     ...
     */
    protected string $view = 'signature::filament.pages.view-signature-with-templates';
}
