<div class="rounded-xl border border-gray-200 dark:border-white/10
    ...
    {{-- Header hint --}}
    <div class="flex items-center gap-2 border-b border-gray-100 dark:border-white/[0.06]
                px-4 py-2.5 bg-gray-50/60 dark:bg-white/[0.03]">
        ...
        <span class="text-xs text-gray-400 dark:text-gray-500">
            Draw your signature, then click <strong class="font-medium text-gray-500 dark:text-gray-400">{{ $field->getConfirmLabel() }}</strong>
        </span>
    </div>
